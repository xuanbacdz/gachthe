<?php
/* ĐƠN VỊ THIẾT KẾ WEB VOTRUNGNHAN | FB.COM/NHANDZPRO */
session_start();
date_default_timezone_set('Asia/Ho_Chi_Minh'); // Timezone VIET NAM <3
$base_url = 'https://maidinhlong.tk/'; // Thay url web bạn
...
class CMSNT
{
    ...
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'mineskym_card', 'mineskym_card', 'mineskym_card') or die ('Vui lòng kết nối đến DATABASE');
